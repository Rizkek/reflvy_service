          ...
          children: [
            Expanded(
              child: _buildStatCard(
                  'Hari Ini', '${stats['today']}', Icons.today, Colors.blue),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: _buildStatCard('Minggu Ini', '${stats['week']}',
                  Icons.date_range, Colors.green),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: _buildStatCard('Bulan Ini', '${stats['month']}',
      ...
      children: [
        Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: () {
                Get.to(() => const HistoryDetectionScreen(),
                    transition: Transition.rightToLeft);
              },
              child: Text(
                'Lihat Semua',
        ...
        Container(
          ...
          child: Column(
            children: [
              _buildActivityItem('Konten NSFW diblokir', '2 menit lalu',
                  Icons.block, Colors.red),
              _buildActivityItem('Website aman diakses', '5 menit lalu',
                  Icons.check_circle, Colors.green),
              _buildActivityItem('Pemindaian selesai', '10 menit lalu',
...
class MonitoringPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(
        child: Text('Halaman Monitoring - Coming Soon'),
      ),
    );
  }
}
